  ...
  <div class="newsList">
    ...
    <div class="contener">
      <div class="newsList_img">
        <div v-for="(item,index) in filteredList" :key="index" class="news_imgage-column">
          ...
          <div class="newsList-body">
            <div class="newsList-item">
              <nuxt-link :to="`/about/notificationList/${ $t($vali.isType(item.slug,$i18n.locale))}`">
                <div class="newsList-title">
                  {{ $t($vali.isType(item.title,$i18n.locale)) }}
                </div>
              </nuxt-link>
